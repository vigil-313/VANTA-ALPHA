...
# Test script for the improved microphone bridge
...
BRIDGE_SCRIPT="/Users/vigil-313/workplace/VANTA-ALPHA/Development/Implementation/scripts/demo/mic_bridge_improved.sh"
...
"$BRIDGE_SCRIPT" > "${LOG_DIR}/bridge_output_${timestamp}.log" 2>&1 &
BRIDGE_PID=$!
...
if [ "$AUDIO_COUNT" -gt 0 ]; then
  ...
  COMBINED_FILE="${LOG_DIR}/combined_test_${timestamp}.wav"
